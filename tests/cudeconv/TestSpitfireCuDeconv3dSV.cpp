...
int main(int argc, char *argv[])
{
    ...
    std::cout << "ref image = " << SAMPLE3DDECONVSV << std::endl;
    ...
    SImg::cuda_spitfire3d_deconv(blurry_image, sx, sy, sz, psf, deconv_image, regularization, weighting, delta, niter, "SV", true, observable);
    ...
    SImageFloat *resultImage = dynamic_cast<SImageFloat *>(SImageReader::read(SAMPLE3DDECONVSV, 32));

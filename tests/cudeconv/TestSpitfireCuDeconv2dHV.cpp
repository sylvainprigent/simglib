...
int main(int argc, char *argv[])
{
    ...
    std::cout << "ref image = " << SAMPLE2DDECONVHV << std::endl;
    ...
    SImg::cuda_spitfire2d_deconv(blurry_image, sx, sy, psf, deconv_image, regularization, weighting, niter, "HV", true, observable);

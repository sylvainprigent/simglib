...
int main(int argc, char *argv[])
{
    ...
    SImg::cuda_spitfire2d_denoise(noisy_image, sx, sy, denoised_image, regularization, weighting, niter, "HV", true, observable);
    delete[] noisy_image; 
    ...
    //SImageReader::write(new SImageFloat(denoised_image, sx, sy), SAMPLE2DDENOISED);

...
int main(int argc, char *argv[])
{
    ...
    SImg::cuda_spitfire3d_denoise(noisy_image, sx, sy, sz, denoised_image, regularization, weighting, niter, deltaz, "SV", true, observable);

    
    SImg::toc();
    delete STimerAccess::instance();

    //SImageReader::write(new SImageFloat(denoised_image, sx, sy, sz), SAMPLE3DDENOISEDSV);

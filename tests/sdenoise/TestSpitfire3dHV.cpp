...
int main(int argc, char *argv[])
{
    ...
    SImg::spitfire3d_hv(noisy_image_norm, sx, sy, sz, denoised_image, regularization, weighting, niter, deltaz, true, observable);
    ...
    //SImageReader::write(new SImageFloat(denoised_image, sx, sy, sz), "./bin/denoised_3d.tif");
